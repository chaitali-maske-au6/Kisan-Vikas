...
var registerForm = document.querySelector(".user-register");
var loginForm = document.querySelector(".login__form");
var googleLogin = document.querySelector(".google-login");
var googleRegister = document.querySelector(".google-register");

var loadMarkUpFromHash = function loadMarkUpFromHash(hash) {
  app.innerHTML = null;
  app.insertAdjacentHTML("afterbegin", markups[hash]);
};

var fetchUserProfile = function fetchUserProfile() {
  _axios.default.get("http://localhost:3000/profile", {
...
if (registerForm) {
  registerForm.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var _e$target, email, password, name, response;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              _e$target = e.target, email = _e$target.email, password = _e$target.password, name = _e$target.name;
              _context.prev = 2;
              _context.next = 5;
...
if (loginForm) {
  loginForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var _e$target2, email, password, response;

      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _e$target2 = e.target, email = _e$target2.email, password = _e$target2.password;
              _context2.prev = 1;
              _context2.next = 4;
...
if (googleLogin) {
  googleLogin.addEventListener("click", /*#__PURE__*/function () {
